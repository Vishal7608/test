...
const Page2 = () => {
  ...
  //   printWindow.document.write('<html><head><title>Quotation Table</title>');
...
<h1 className="service-quotation-title">Service Quotation</h1>
...
<div className="page2bt">
  <button className="add-btn" onClick={handleAddQuotation}>Add to Quotation</button>

  <button className="print-btn" >Print Quotation</button>
  {/* <button className="print-btn" onClick={handlePrint}>Print Quotation</button> */}
</div>
</div>
